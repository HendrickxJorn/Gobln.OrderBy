...
{
    [TestClass]
    public class QueryableOrderByDbTest
    {
        [TestMethod]
        public void OrderByDbTestWithStringTest1()
        {
            using (var context = new MoonWalkerContext())
            {
                ...
                var list = context.MoonWalkers.AsQueryable().OrderBy(" firstname       Desc; LunarEvaDate asc ; ").ToList();
        ...
        public void OrderByDbTest1()
        {
            using (var context = new MoonWalkerContext())
            {
                ...
                var list = context.MoonWalkers.AsQueryable().OrderBy("LunarEvaDate").ToArray();
        ...
        public void OrderByDbTest2()
        {
            using (var context = new MoonWalkerContext())
            {
                ...
                var list = context.MoonWalkers.AsQueryable().OrderBy("FirstName", false).ToList();
        ...
        public void OrderByDbTest3()
        {
            ...
            {
                // orderby LunarEvaDate ascending
                var list = context.MoonWalkers.AsQueryable().OrderBy("lunarevadate", "asc").ToList();
        ...
        public void OrderByDbTest4()
        {
            using (var context = new MoonWalkerContext())
            {
                ...
                var list = context.MoonWalkers.AsQueryable().OrderBy("LunarEvaDate", OrderDirectionEnum.Descending).ToList();
        ...
        public void OrderByDbTest5()
        {
            using (var context = new MoonWalkerContext())
            {
                ...
                var list = context.MoonWalkers.AsQueryable().OrderBy("LastName", true).ToList();
        ...
        public void OrderByDbTest6()
        {
            ...
            {
                // orderby LunarEvaDate descending
                var list = context.MoonWalkers.AsQueryable().OrderBy("LunarEvaDate", "descending").ToList();
        ...
        public void OrderByDbTest7()
        {
            ...
            {
                // orderby LastName descending
                var list = context.MoonWalkers.AsQueryable().OrderBy(new OrderItem() { SortColum = "LastName", OrderDirection = OrderDirectionEnum.Descending }).ToList();
        ...
        public void OrderByDbNaturalSortComparerTest1()
        {
            using (var context = new MoonWalkerContext())
            {
                ...
                var list = context.MoonWalkers.AsQueryable().OrderBy("GuiId", false, new NaturalSortComparer()).ToList();
        ...
        public void OrderByDbNaturalSortComparerTest2()
        {
            using (var context = new MoonWalkerContext())
            {
                ...
                // Will not work, Comparer is not supported in EF or linq-to-sql
                var list = context.MoonWalkers.AsQueryable().OrderBy(orderItem).ToList();
        ...
        public void OrderByDbOrderItemTest1()
        {
            using (var context = new MoonWalkerContext())
            {
                ...
                var list = context.MoonWalkers.AsQueryable().OrderBy(orderItems).ToList();
