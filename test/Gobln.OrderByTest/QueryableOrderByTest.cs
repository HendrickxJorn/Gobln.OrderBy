...
{ 
    [TestClass]
    public class QueryableOrderByTest
    {
        [TestMethod]
        public void OrderByTestWithStringTest1()
        {
            // order by FirstName Descending then by LunarEvaDate
            var list = TestData.MoonWalkers.AsQueryable().OrderBy(" firstname       Desc; LunarEvaDate asc ; ").ToList();
        ...
        public void OrderByTest1()
        {
            ...
            var list = TestData.MoonWalkers.AsQueryable().OrderBy("LunarEvaDate").ToArray();
        ...
        public void OrderByTest2()
        {
            ...
            var list = TestData.MoonWalkers.AsQueryable().OrderBy("FirstName", false).ToList();
        ...
        {
            // orderby LunarEvaDate ascending
            var list = TestData.MoonWalkers.AsQueryable().OrderBy("lunarevadate", "asc").ToList();
        ...
        public void OrderByTest4()
        {
            ...
            var list = TestData.MoonWalkers.AsQueryable().OrderBy("LunarEvaDate", OrderDirectionEnum.Descending).ToList();
        ...
        public void OrderByTest5()
        {
            ...
            var list = TestData.MoonWalkers.AsQueryable().OrderBy("LastName", true).ToList();
        ...
        {
            // orderby LastName descending
            var list = TestData.MoonWalkers.AsQueryable().OrderBy(new OrderItem() { SortColum = "LastName", OrderDirection = OrderDirectionEnum.Descending }).ToList();
        ...
        {
            var list = TestData.MoonWalkers.AsQueryable().OrderBy("GuiId", OrderDirectionEnum.Ascending, new NaturalSortComparer()).ToList();
        ...
        public void OrderByNaturalSortComparerTest2()
        {
            ...
            var list = TestData.MoonWalkers.AsQueryable().OrderBy(orderItem).ToList();
        ...
        public void OrderByNaturalSortComparerTest3()
        {
            ...
            TestData.MoonWalkers.AsQueryable().OrderBy("Id", OrderDirectionEnum.Ascending, new NaturalSortComparer()).ToList();
        }

        [TestMethod]
        public void OrderByNaturalSortComparerTest4()
        {
            var list = TestData.MoonWalkers.AsQueryable().OrderBy(c => c.FirstName).ThenBy("GuiId", OrderDirectionEnum.Ascending, new NaturalSortComparer()).ToList();
        ...
        public void OrderByOrderItemTest1()
        {
            ...
            var list = TestData.MoonWalkers.AsQueryable().OrderBy(orderItems).ToList();
